...
def main():
    ...
    try:
        ...
        init_pos = robot_controller.get_current_joint_values()
        print("Initial positions set to: ", init_pos)

        # Robot degrees of freedom
        DOF = robot_controller.get_DOF()
        ...
        while True:
            ...
            # Send command
            robot_controller.move_arm_to_joint_values(target_pos, target_vel, target_acc, MAX_VEL, MAX_ACC)
