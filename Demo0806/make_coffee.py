...
sys.path.append("/home/jzj/BestMan_Flexiv")
# Check sys.path
...
def main():
    ...
    try:
        ...
        #pose for uav to fly to table
        # pose0 = [-0.24028761684894562, 0.7724065184593201, 0.1090809777379036, 2.12669038772583, 0.08735869079828262, -0.21450810134410858, -0.219651460647583]
        # pose0 = pose_to_euler(pose0)
        # bestman.move_end_effector_to_goal_pose(pose0)
        # time.sleep(5)
        pose0 = [0.21, -0.11, 0.47, 0.00, -0.04, 1.00, 0.00] 
        pose0 = pose_to_euler(pose0)
        bestman.move_end_effector_to_goal_pose(pose0)
        time.sleep(5)
